...
Reading this file teaches you very little. Writing these five programs teaches you most of it. Keep each one in its own file inside `python-basics`.
...
Three places hold everything above.

**[The Python Tutorial](https://docs.python.org/3/tutorial/index.html)** — the official walkthrough of the language, written for people learning it. Its early chapters cover the interpreter, numbers and strings, and formatted output with f-strings; the errors chapter covers every message in the table above.

**[Built-in Functions](https://docs.python.org/3/library/functions.html)** — the exact definition of every function used in this file: `print`, `input`, `type`, `int`, `float` and `str`.

**[PEP 8 — Style Guide for Python Code](https://peps.python.org/pep-0008/)** — the official rules on naming, spacing, indentation and line length. Read the naming conventions and code layout sections now; the rest will make sense as the course goes on.
